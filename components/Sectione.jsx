    ...
    <div className="pt-[189px] mx-4 max-w-[1280px] lg:mx-auto">
      <div className="flex flex-col justify-center items-center">
        ...
        <div className="relative mt-20 h-[1100px] lg:w-[1000px] xl:w-[1100px] bg-[#F8FAFC] rounded-[20px] drop-shadow-2xl">
          ...
          <div className="absolute left-5 xl:left-24 top-[165px] flex lg:flex-row flex-col space-y-10 lg:space-y-0 lg:space-x-7  ">
      ...
      <div className="pt-[349px] flex flex-col items-center justify-center">
        ...
        <div className="flex lg:flex-row flex-col space-y-32 lg:space-x-52 pt-[142px]">
          ...
          <div className="flex flex-col items-center lg:h-[55px] w-[205px] space-y-4">
            <Image src={"/images/lectro.png"} height={25} width={125} />
